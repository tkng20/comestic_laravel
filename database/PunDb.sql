...
CREATE TABLE `products` (
  ...
  `photo4` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_coupon_id_foreign` FOREIGN KEY (`coupon_id`) REFERENCES `coupons` (`id`) ON DELETE SET NULL;
--
