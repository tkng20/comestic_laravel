        ...
        <div class="pcoded-content">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb ">
                                ...
                                <li class="breadcrumb-item"><a href="#">Post Tags</a></li>
                                <li class="breadcrumb-item">All Post Tags</li>
                            </ul>
                            <h6 class="float-right">Total Post Tags:
                                {{ App\Models\PostTag::count() }}
                            </h6>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="float-left">Post Tag Lists </h2>
                            <div class="float-right">
                                <a class="float-left mr-1" href="{{ route('post_tag.create') }}" style="color:black;">
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                                    <a href="{{ route('post_tag.edit', $item->id) }}"
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6">
                                                                    <form method="POST"
                                                                        action="{{ route('post_tag.destroy', [$item->id]) }}">
                                                                        @csrf
                                                                        @method('delete')
