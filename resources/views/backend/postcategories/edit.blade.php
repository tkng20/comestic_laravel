                        ...
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('post_category.index') }}">Post
                                        Categoriess</a></li>
                                <li class="breadcrumb-item">Edit Post Category</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="post" action="{{ route('post_category.update', $postCategory->id) }}">
                                        {{-- {{ csrf_field() }} --}}
                                        @csrf
                                        @method('patch')
                                        <!--Title-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                <option value="active"
                                                    {{ $postCategory->status == 'active' ? 'selected' : '' }}>
                                                    Active
                                                </option>
                                                <option value="inactive"
                                                    {{ $postCategory->status == 'inactive' ? 'selected' : '' }}>
                                                    Inactive
                                                </option>
                                            </select>
                                            @error('status')
