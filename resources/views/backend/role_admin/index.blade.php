        ...
        <div class="pcoded-content">
                ...
                <div class="page-block">
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <h6 class="float-right">Total Admins:
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2 class="float-left">Admin Lists </h2>
                            <div class="float-right">
                                <a class="float-left mr-1" href="{{ route('user.create') }}" style="color:black;">
                                                ...
                                                @foreach ($users as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if ($item->photo)
                                                                <img src="{{ $item->photo }}"
                                                                    class="img-fluid zoom rounded-circle"
                                                                    style="max-width: 50px;" alt="{{ $item->photo }}">
                                                            @else
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <p>{!! html_entity_decode($user->address) !!}</p>
                                                                        </div>
                                                                        <div class="row">
                                                                            <div class="col-lg-6 col-md-6 col-sm-6">
                                                                                <strong>Role</strong>
...
@section('scripts')
    ...
    <script>
        $('input[name=toogle]').change(function() {
            ...
            // alert(id);
            $.ajax({
                url: "{{ route('role_admin.roleAdminStatus') }}",
                type: "POST",
                data: {
                    _token: "{{ csrf_token() }}",
                    mode: mode,
